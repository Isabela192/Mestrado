...
__builtins__ = {}
__doc__ = None
__file__ = '/home/isabela/anaconda3/envs/radar/lib/python3.6/site-packages/pandas/_libs/window.cpython-36m-x86_64-linux-gnu.so'
...
def roll_max(input, win, minp, index, closed):
...
def roll_min(input, win, minp, index, closed):
    '\n    Moving max of 1d array of any numeric type along axis=0 ignoring NaNs.\n\n    Parameters\n    ----------\n    input: numpy array\n    window: int, size of rolling window\n    minp: if number of observations in window\n          is below this, output a NaN\n    index: ndarray, optional\n       index for window computation\n    '
    pass
